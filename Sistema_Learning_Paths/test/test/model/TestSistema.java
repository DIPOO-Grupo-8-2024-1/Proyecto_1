...
public class TestSistema {
    ...
    public static void main(String[] args) {
        ...
        // Crear actividades
        Tarea tarea1 = new Tarea(1, "Tarea 1", "Completar ejercicios de Java", 120, "Realizar los ejercicios prácticos");
        ...
        Quiz quiz = new Quiz(3, "Quiz de Programación", "Evaluar conocimientos de Java", 30, Arrays.asList(pregunta1, preguntaAbierta), 6);
