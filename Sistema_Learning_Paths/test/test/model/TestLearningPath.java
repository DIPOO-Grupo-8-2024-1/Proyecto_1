...
public class TestLearningPath {
    ...
    public static void main(String[] args) {
        ...
        Tarea tarea1 = new Tarea(1, "Tarea 1", "Completar ejercicios de programación", 120, "Ejercicios prácticos de Java");
        Recurso recurso1 = new Recurso(2, "Recurso 1", "Leer artículo sobre POO", 90, "artículo", "https://articulo.com");
        ...
        // Crear un quiz
        Quiz quiz1 = new Quiz(3, "Quiz de Programación", "Evaluar conocimientos básicos de programación", 30, Arrays.asList(pregunta1, pregunta2), 6);
